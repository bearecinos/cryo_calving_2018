...
if Plot_fig_2:
    ...
    graphics.plot_inversion(gdir, ax=axs[0], title='', linewidth=2,
    ...
    plot_inversion_with_calving(gdir, ax=axs[1], k=k, title='', linewidth=2,
...
if Plot_fig_3:
    ...
    inv_c = gdir.read_pickle('inversion_output',
                               filesuffix='_with_calving'+str(k))[-1]
